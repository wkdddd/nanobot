          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            {onSessionApprovalChange ? (
              <Button
                ...
                variant="ghost"
                disabled={disabled}
                aria-pressed={sessionApprovalEnabled}
                aria-label={
                  sessionApprovalEnabled
                    ? t("permission.toggleOff")
                    : t("permission.toggleOn")
                }
                title={
                  sessionApprovalEnabled
                    ? t("permission.toggleOff")
                ...
                onClick={() => onSessionApprovalChange(!sessionApprovalEnabled)}
                className={cn(
                  ...
                  sessionApprovalEnabled
                    ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-700 hover:bg-emerald-500/12 dark:text-emerald-300"
                    : "bg-card text-muted-foreground hover:bg-card hover:text-foreground",
                )}
              >
                {sessionApprovalEnabled ? (
                  <ShieldCheck className={cn("mr-1.5", isHero ? "h-4 w-4" : "h-3.5 w-3.5")} />
                ) : (
